...
const API = "https://shikshabackend.onrender.com";
    ...
    <div style={styles.container}>
      ...
      <aside style={styles.sidebar}>
        <div style={styles.sidebarLogo}>
          ...
          <span style={styles.sideLogoText} className="glow-text">Shiksha AI</span>
        </div>
...
const styles = {
  container: { display: "flex", minHeight: "100vh", background: "var(--bg-primary)", position: "relative", flexDirection: "row" },  bgGrid: { position: "fixed", inset: 0, backgroundImage: "linear-gradient(rgba(79,142,247,0.02) 1px, transparent 1px), linear-gradient(90deg, rgba(79,142,247,0.02) 1px, transparent 1px)", backgroundSize: "60px 60px", pointerEvents: "none" },
